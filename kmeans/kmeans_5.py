...
if __name__ == '__main__':
    ...
    ranPoint = random.choice(train_y_39)   # first point  Randomly select
    ...
    class_2Point,class_3Point,class_4Point,class_5Point=initial_point(ranPoint,5,train_y_39,train_x)
    ...
    while lop : 
        ...
        for i in range(len(train_y_39)):
            ...
            dis_min=[dis_1p,dis_2p,dis_3p,dis_4p,dis_5p]
            max_cls=np.argmin(dis_min)
        # class_1.append(train_y_39[i]) if dis_1p>dis_2p else class_2.append(train_y_39[i])     ## clssification
            class_1.append(train_y_39[i]) if max_cls==0 else class_2.append(train_y_39[i]) if max_cls==1 else class_3.append(train_y_39[i]) if max_cls==2 else class_4.append(train_y_39[i]) if max_cls==3 else class_5.append(train_y_39[i])
        ...
        if (mean_1==class_1Point).all() == "False" or (mean_2==class_2Point).all()=="False" or (mean_3==class_3Point).all()=="False" or (mean_4==class_4Point).all()=="False" or (mean_5==class_5Point).all()=="False":
            class_1Point = mean_1
            class_2Point = mean_2
            class_3Point = mean_3
            class_4Point = mean_4
