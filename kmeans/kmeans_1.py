...
if __name__ == '__main__':
    ...
    cov_mat = np.dot(train_x_zero.transpose(), train_x_zero)/N             #convariance Matrix
    ...
    class_2Point=initial_point(ranPoint,2,train_y_39,train_x)    #logest distance point from the initial point of class2 = class2
    ranPoint = random.choice(train_y_39)   # randomly initial point for class3
    class_3Point = train_x[ranPoint]
    ...
    while lop : 
        ...
        for i in range(len(train_y_39)):
            ...
            dis_min=[dis_1p,dis_2p,dis_3p]
            max_cls=np.argmin(dis_min)
        # class_1.append(train_y_39[i]) if dis_1p>dis_2p else class_2.append(train_y_39[i])     ## clssification
            class_1.append(train_y_39[i]) if max_cls==0 else class_2.append(train_y_39[i]) if max_cls==1 else class_3.append(train_y_39[i]) 
        ...
        if (mean_1==class_1Point).all() == "False" or (mean_2==class_2Point).all()=="False" or (mean_3==class_3Point).all()=="False" :
            class_1Point = mean_1
            class_2Point = mean_2
            class_3Point = mean_3
            print "change"
